                ...
                <table id="table" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Surat Pengantar Dari polres</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->data_polres_surat_pengantar_dari_biro }}</td>
                            <td style="text-align: center">
                                <a onclick="edit('{{$row->data_polres_id}}','{{$row->polres_id}}','{{$row->data_polres_tgl}}','{{$row->data_polres_sim_a_baru}}','{{$row->data_polres_sim_a_perpanjang}}','{{$row->data_polres_sim_c_baru}}','{{$row->data_polres_sim_c_perpanjang}}','{{$row->data_polres_surat_pengantar_dari_biro}}')" class="icon-edit"></a>
